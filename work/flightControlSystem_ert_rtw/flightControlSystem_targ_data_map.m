    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.o2bigtykub
                    section.data(1).logicalSrcIdx = 3;
                    section.data(1).dtTransOffset = 0;

                    ;% ntrh2fpvwnc.bvcuew3ckf
                    section.data(2).logicalSrcIdx = 4;
                    section.data(2).dtTransOffset = 1;

                    ;% ntrh2fpvwnc.lxt33vyawp
                    section.data(3).logicalSrcIdx = 5;
                    section.data(3).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.l5l2avt4o3
                    section.data(4).logicalSrcIdx = 6;
                    section.data(4).dtTransOffset = 2147;

                    ;% ntrh2fpvwnc.hfaa03tsms
                    section.data(5).logicalSrcIdx = 7;
                    section.data(5).dtTransOffset = 4292;

                    ;% ntrh2fpvwnc.ehp4adgrhl
                    section.data(6).logicalSrcIdx = 8;
                    section.data(6).dtTransOffset = 4293;

                    ;% ntrh2fpvwnc.jmteaszawm
                    section.data(7).logicalSrcIdx = 9;
                    section.data(7).dtTransOffset = 4294;

                    ;% ntrh2fpvwnc.lxpwxz5bwh
                    section.data(8).logicalSrcIdx = 10;
                    section.data(8).dtTransOffset = 4295;
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.n5cn1sweqg
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.emfpxywvxd
                    section.data(6).logicalSrcIdx = 16;
                    section.data(6).dtTransOffset = 9;

                    ;% ntrh2fpvwnc.fxgka2mnesn.bkcxpyjvio
                    section.data(7).logicalSrcIdx = 17;
                    section.data(7).dtTransOffset = 10;

                    ;% ntrh2fpvwnc.fxgka2mnesn.nfrqx5s0p2
                    section.data(8).logicalSrcIdx = 18;
                    section.data(8).dtTransOffset = 11;

                    ;% ntrh2fpvwnc.fxgka2mnesn.dyv4r1jyb4
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.ea5vukncdp
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.gjjz35gbc5
                    section.data(7).logicalSrcIdx = 11;
                    section.data(7).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ikwyv5y3f0
                    section.data(8).logicalSrcIdx = 12;
                    section.data(8).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.fxgka2mnesn.etknzym0xp
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.dpslavm030
                    section.data(1).logicalSrcIdx = 45;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.gyri2ahfgf
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.hidi3atqpn
                    section.data(1).logicalSrcIdx = 47;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.bpvq0ji2ib
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.iq1bnc3ivl
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.bhg3322vdk
                    section.data(1).logicalSrcIdx = 58;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.idz3mlymtu
                    section.data(2).logicalSrcIdx = 59;
                    section.data(2).dtTransOffset = 1;
    ...
    targMap.checksum0 = 2374029830;
    targMap.checksum1 = 2478371762;
    targMap.checksum2 = 2290530475;
    targMap.checksum3 = 4079875357;
